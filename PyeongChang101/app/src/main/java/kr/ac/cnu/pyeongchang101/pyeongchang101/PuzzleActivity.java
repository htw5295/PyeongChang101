...
//    }
    ...
    public void onClickPuzzleBlock(View view) {
        if (check[Integer.parseInt((String)view.getTag())] == 0) {
            view.setBackgroundResource(R.drawable.puzzle_block_blue);
            check[Integer.parseInt((String)view.getTag())] = 1;
        } else {
            view.setBackgroundResource(R.drawable.puzzle_block_black);
            check[Integer.parseInt((String)view.getTag())] = 0;
        }
    }
